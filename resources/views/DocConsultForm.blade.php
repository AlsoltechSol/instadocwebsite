                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <input name="lab_center" type="text" class="form-control" id="Dest" placeholder="Departments" required>
                        </div>
                        <div class="col-md-6 mb-1">
                            <label for="country" class="form-label">Doctors</label>
                            <input name="alt_mobile" type="text" class="form-control" id="country" placeholder="Doctors" required>
                        </div>
